...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Host'
        db.create_table(u'secrets_host', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('apikey', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['authtoken.Token'], null=True, blank=True)),
        ))
        db.send_create_signal(u'secrets', ['Host'])

        # Adding model 'Secret'
        db.create_table(u'secrets_secret', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('content', self.gf('encrypted_fields.fields.EncryptedTextField')()),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
    ...
    def backwards(self, orm):
        # Deleting model 'Host'
        db.delete_table(u'secrets_host')

        # Deleting model 'Secret'
        db.delete_table(u'secrets_secret')
    ...
    models = {
        ...
        u'secrets.host': {
            ...
            'apikey': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['authtoken.Token']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
